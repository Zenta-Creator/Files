This is a duckyscript that will create a WiFi folder on C drive. it will add a .txt file called test6.txt containing all saved wfif's with passwords and info, and save it into the DIR.
